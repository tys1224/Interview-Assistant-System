# -*- coding: utf-8 -*-
"""
Created on Fri May 29 01:16:52 2020
...
from PyQt5.QtWidgets import QWidget, QApplication, QGroupBox, QPushButton, QLabel, QHBoxLayout,  QVBoxLayout, QGridLayout, QLineEdit,QMessageBox, QDesktopWidget
...
class Interview(QWidget):
    ...
    def initUi(self):
        ...
        self.undercamera()
        self.setGeometry(40,50,1500,900)
        ...
        self.Oneshots()
        path = 'D:\\Aubrey_file\\Main\\interview.docx'                           
    ...
    def calldeception(self):
        c = 1
        if(c <= 20):
                self.timer_deception.start(15000)
